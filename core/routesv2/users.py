...
from core.modelsv2.orders import OrderModel
from core.modelsv2.users import UserModel, UpdateUserModel
from typing import List
from fastapi.encoders import jsonable_encoder
from core.config.config import db
from core.routes.orders import create_order
...
# CREATING A USER
# FLOW -> CREATE AN EMPTY ORDER -> CREATE AN USER WITH NEW ORDER -> RETURN USER WITH NEW ORDER
